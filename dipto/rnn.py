...
"""
It create a neural network with the following parameter
and then fit it
"""
...
class rnn(TFBaseModel):
    ...
    It serves the same purpose as the Maximum Log Likelihood. However, 
    since most optimization problems typically attempt to minimize a function, 
    the negative log likelihood is what is preferred to the Maximum Log likelihood.
    """
    def NLL(self, y, lengths, pis, mus, sigmas, rho, es, eps=1e-8):
        ...
        # Guassian Mixture Model for 
        """
        GMMs are very useful when you know the general shape of the curve that your clusters follow 
        (e.g., linear or quadratic).
         Their undoing is non-Gaussian distribution of data in clusters. 
        So if your data distribution is expected to have a heavy tail (to be skewed),
        """
        ...
        """
            here we create sample for our next cel
        """
